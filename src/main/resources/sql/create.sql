...
INSERT INTO `configuration_data` VALUES (3,487006,'play_v2_3900602','Ajo,Cantabria');

CREATE TABLE `dive_day` (
  `dive_day_id` int NOT NULL AUTO_INCREMENT,
  `day` int NOT NULL,
  `beginning` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
  `end` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `fish` (
  ...
  `site` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `first_sighting` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
  `first_last` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
  `start_season` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
  `end_season` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
  `first_life_warning` varchar(5) COLLATE utf8mb4_general_ci NOT NULL,
  PRIMARY KEY (`id`)
